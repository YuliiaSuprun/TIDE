...
goal(and(eventually(and(on(b2, b1), next(eventually(and(on(b3, b2), next(eventually(and(on(b4, b3), and(next(eventually(on(b6, b5))), and(next(eventually(on(b8, b7))), and(next(eventually(on(b10, b9))), and(next(eventually(on(b12, b11))), next(eventually(on(b14, b13))))))))))))))), eventually(and(on(b13, b14), next(eventually(and(on(b12, b13), next(eventually(and(on(b11, b12), next(eventually(and(on(b10, b11), next(eventually(and(on(b9, b10), next(eventually(and(on(b8, b9), next(eventually(and(on(b7, b8), next(eventually(and(on(b6, b7), next(eventually(and(on(b5, b6), next(eventually(and(on(b4, b5), next(eventually(and(on(b3, b4), next(eventually(and(on(b2, b3), next(eventually(on(b1, b2)))))))))))))))))))))))))))))))))))))))).
