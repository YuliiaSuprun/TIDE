...
goal(and(until(ontable(b1), on(b2, b3)), and(until(ontable(b1), on(b3, b4)), and(until(ontable(b1), on(b4, b5)), and(until(ontable(b1), on(b5, b6)), until(ontable(b1), holding(b1))))))).
