...
goal(eventually(and(eventually(communicated_soil_data(waypoint1)), and(eventually(communicated_soil_data(waypoint2)), eventually(communicated_rock_data(waypoint0)))))).
