...
initially_true(ontable(b23)).
initially_true(ontable(b24)).
initially_true(ontable(b25)).
initially_true(ontable(b26)).
initially_true(ontable(b27)).
initially_true(ontable(b28)).
initially_true(ontable(b29)).
initially_true(ontable(b30)).
...
initially_true(clear(b23)).
initially_true(clear(b24)).
initially_true(clear(b25)).
initially_true(clear(b26)).
initially_true(clear(b27)).
initially_true(clear(b28)).
initially_true(clear(b29)).
initially_true(clear(b30)).
...
goal(and(eventually(and(on(b2, b1), next(eventually(and(on(b3, b2), next(eventually(and(on(b4, b3), and(next(eventually(on(b6, b5))), and(next(eventually(on(b8, b7))), and(next(eventually(on(b10, b9))), and(next(eventually(on(b12, b11))), and(next(eventually(on(b14, b13))), and(next(eventually(on(b16, b15))), and(next(eventually(on(b18, b17))), and(next(eventually(on(b20, b19))), and(next(eventually(on(b22, b21))), and(next(eventually(on(b24, b23))), and(next(eventually(on(b26, b25))), and(next(eventually(on(b28, b27))), next(eventually(on(b30, b29))))))))))))))))))))))), eventually(and(on(b29, b30), next(eventually(and(on(b28, b29), next(eventually(and(on(b27, b28), next(eventually(and(on(b26, b27), next(eventually(and(on(b25, b26), next(eventually(and(on(b24, b25), next(eventually(and(on(b23, b24), next(eventually(and(on(b22, b23), next(eventually(and(on(b21, b22), next(eventually(and(on(b20, b21), next(eventually(and(on(b19, b20), next(eventually(and(on(b18, b19), next(eventually(and(on(b17, b18), next(eventually(and(on(b16, b17), next(eventually(and(on(b15, b16), next(eventually(and(on(b14, b15), next(eventually(and(on(b13, b14), next(eventually(and(on(b12, b13), next(eventually(and(on(b11, b12), next(eventually(and(on(b10, b11), next(eventually(and(on(b9, b10), next(eventually(and(on(b8, b9), next(eventually(and(on(b7, b8), next(eventually(and(on(b6, b7), next(eventually(and(on(b5, b6), next(eventually(and(on(b4, b5), next(eventually(and(on(b3, b4), next(eventually(and(on(b2, b3), next(eventually(on(b1, b2)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))).
