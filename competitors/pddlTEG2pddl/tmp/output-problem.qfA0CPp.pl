...
goal(eventually(or(always(communicated_soil_data(waypoint1)), or(always(communicated_soil_data(waypoint2)), or(always(communicated_rock_data(waypoint0)), always(communicated_rock_data(waypoint1))))))).
