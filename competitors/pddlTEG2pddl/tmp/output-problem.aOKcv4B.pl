...
goal(eventually(or(eventually(communicated_soil_data(waypoint1)), or(eventually(communicated_soil_data(waypoint2)), or(eventually(communicated_rock_data(waypoint0)), eventually(communicated_rock_data(waypoint1))))))).
