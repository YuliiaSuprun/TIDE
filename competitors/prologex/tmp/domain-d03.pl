...
poss(o_goal, and(and(f_world, f_ok), and(not(q_1), and(not(q_2), and(not(q_3), and(not(q_4), and(not(q_5), and(not(q_6), and(not(q_7), and(not(q_8), and(not(q_9), not(q_10)))))))))))).
...
causes_true(q_4s, o_sync_q_1s, q_1s).
...
causes_true(f_world, o_sync_q_11s, true).
causes_true(q_1, o_sync_q_11s, q_1s).
causes_true(q_2, o_sync_q_11s, q_2s).
causes_true(q_3, o_sync_q_11s, q_3s).
causes_true(q_4, o_sync_q_11s, q_4s).
causes_true(q_5, o_sync_q_11s, q_5s).
causes_true(q_6, o_sync_q_11s, q_6s).
causes_true(q_7, o_sync_q_11s, q_7s).
causes_true(q_8, o_sync_q_11s, q_8s).
causes_true(q_9, o_sync_q_11s, q_9s).
causes_true(q_10, o_sync_q_11s, q_10s).
causes_true(q_11, o_sync_q_11s, q_11s).
...
causes_false(f_ok, o_sync_q_6s, and(q_6s, not(on(b3, b4)))).
...
causes_false(f_ok, o_sync_q_8s, and(q_8s, not(ontable(b1)))).
causes_false(q_8t, o_sync_q_8s, true).
causes_false(q_9s, o_sync_q_9s, q_9s).
causes_false(f_ok, o_sync_q_9s, and(q_9s, not(holding(b1)))).
causes_false(q_9t, o_sync_q_9s, true).
causes_false(q_10s, o_sync_q_10s, q_10s).
causes_false(q_10t, o_sync_q_10s, true).
causes_false(f_ok, o_sync_q_11s, q_11s).
causes_false(q_11t, o_sync_q_11s, true).
causes_false(f_sync, o_sync_q_11s, true).
causes_false(q_1s, o_sync_q_11s, true).
causes_false(q_2s, o_sync_q_11s, true).
causes_false(q_3s, o_sync_q_11s, true).
causes_false(q_4s, o_sync_q_11s, true).
causes_false(q_5s, o_sync_q_11s, true).
causes_false(q_6s, o_sync_q_11s, true).
causes_false(q_7s, o_sync_q_11s, true).
causes_false(q_8s, o_sync_q_11s, true).
causes_false(q_9s, o_sync_q_11s, true).
causes_false(q_10s, o_sync_q_11s, true).
causes_false(q_11s, o_sync_q_11s, true).
