...
causes_true(q_14, o_sync_q_5s_1, q_5s).
causes_true(q_6t, o_sync_q_5s_1, true).
causes_true(q_9s, o_sync_q_5s_2, q_5s).
...
causes_true(q_14, o_sync_q_6s_1, q_6s).
causes_true(q_7t, o_sync_q_6s_1, true).
causes_true(q_10s, o_sync_q_6s_2, q_6s).
...
causes_true(q_14, o_sync_q_7s_1, q_7s).
...
causes_true(q_14, o_sync_q_8s_1, q_8s).
causes_true(q_9t, o_sync_q_8s_1, true).
causes_true(q_12s, o_sync_q_8s_2, q_8s).
