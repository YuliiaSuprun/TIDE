...
causes_true(q_6s, o_sync_q_1s_1, q_1s).
...
causes_true(q_12s, o_sync_q_6s_1, q_6s).
causes_true(q_7t, o_sync_q_6s_1, true).
causes_true(q_18, o_sync_q_6s_2, q_6s).
