...
causes_true(q_9s, o_sync_q_4s_1, q_4s).
causes_true(q_5t, o_sync_q_4s_1, true).
causes_true(q_5s, o_sync_q_4s_2, q_4s).
...
causes_false(f_ok, o_sync_q_5s, and(q_5s, 'started-o1')).
...
causes_false(f_ok, o_sync_q_9s, and(q_9s, not('started-o2'))).
causes_false(q_9t, o_sync_q_9s, true).
causes_false(q_10s, o_sync_q_10s, q_10s).
causes_false(f_ok, o_sync_q_10s, and(q_10s, not('shipped-o3'))).
causes_false(q_10t, o_sync_q_10s, true).
causes_false(q_11s, o_sync_q_11s, q_11s).
causes_false(f_ok, o_sync_q_11s, and(q_11s, not('shipped-o2'))).
causes_false(q_11t, o_sync_q_11s, true).
causes_false(q_12s, o_sync_q_12s, q_12s).
causes_false(f_ok, o_sync_q_12s, and(q_12s, not('shipped-o1'))).
