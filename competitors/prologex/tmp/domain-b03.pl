...
poss(o_goal, and(and(f_world, f_ok), and(not(q_1), and(not(q_2), and(not(q_3), and(not(q_4), and(not(q_5), and(not(q_6), and(not(q_7), and(not(q_8), and(not(q_9), and(not(q_10), and(not(q_11), not(q_12)))))))))))))).
...
causes_true(q_12, o_sync_q_5s_2, q_5s).
...
causes_true(q_12, o_sync_q_6s_2, q_6s).
...
causes_true(q_12, o_sync_q_7s_2, q_7s).
...
causes_true(f_world, o_sync_q_13s, true).
causes_true(q_1, o_sync_q_13s, q_1s).
causes_true(q_2, o_sync_q_13s, q_2s).
causes_true(q_3, o_sync_q_13s, q_3s).
causes_true(q_4, o_sync_q_13s, q_4s).
causes_true(q_5, o_sync_q_13s, q_5s).
causes_true(q_6, o_sync_q_13s, q_6s).
causes_true(q_7, o_sync_q_13s, q_7s).
causes_true(q_8, o_sync_q_13s, q_8s).
causes_true(q_9, o_sync_q_13s, q_9s).
causes_true(q_10, o_sync_q_13s, q_10s).
causes_true(q_11, o_sync_q_13s, q_11s).
causes_true(q_12, o_sync_q_13s, q_12s).
causes_true(q_13, o_sync_q_13s, q_13s).
...
causes_false(f_ok, o_sync_q_8s, and(q_8s, not(on(b6, b1)))).
...
causes_false(f_ok, o_sync_q_13s, q_13s).
causes_false(q_13t, o_sync_q_13s, true).
causes_false(f_sync, o_sync_q_13s, true).
causes_false(q_1s, o_sync_q_13s, true).
causes_false(q_2s, o_sync_q_13s, true).
causes_false(q_3s, o_sync_q_13s, true).
causes_false(q_4s, o_sync_q_13s, true).
causes_false(q_5s, o_sync_q_13s, true).
causes_false(q_6s, o_sync_q_13s, true).
causes_false(q_7s, o_sync_q_13s, true).
causes_false(q_8s, o_sync_q_13s, true).
causes_false(q_9s, o_sync_q_13s, true).
causes_false(q_10s, o_sync_q_13s, true).
causes_false(q_11s, o_sync_q_13s, true).
causes_false(q_12s, o_sync_q_13s, true).
causes_false(q_13s, o_sync_q_13s, true).
