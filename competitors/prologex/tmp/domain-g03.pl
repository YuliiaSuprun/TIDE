...
poss(o_goal, and(and(f_world, f_ok), and(not(q_1), and(not(q_2), and(not(q_3), and(not(q_4), and(not(q_5), and(not(q_6), and(not(q_7), and(not(q_8), and(not(q_9), and(not(q_10), and(not(q_11), and(not(q_12), and(not(q_13), and(not(q_14), and(not(q_15), and(not(q_16), not(q_17))))))))))))))))))).
...
causes_true(f_world, o_sync_q_18s, true).
causes_true(q_1, o_sync_q_18s, q_1s).
causes_true(q_2, o_sync_q_18s, q_2s).
causes_true(q_3, o_sync_q_18s, q_3s).
causes_true(q_4, o_sync_q_18s, q_4s).
causes_true(q_5, o_sync_q_18s, q_5s).
causes_true(q_6, o_sync_q_18s, q_6s).
causes_true(q_7, o_sync_q_18s, q_7s).
causes_true(q_8, o_sync_q_18s, q_8s).
causes_true(q_9, o_sync_q_18s, q_9s).
causes_true(q_10, o_sync_q_18s, q_10s).
causes_true(q_11, o_sync_q_18s, q_11s).
causes_true(q_12, o_sync_q_18s, q_12s).
causes_true(q_13, o_sync_q_18s, q_13s).
causes_true(q_14, o_sync_q_18s, q_14s).
causes_true(q_15, o_sync_q_18s, q_15s).
causes_true(q_16, o_sync_q_18s, q_16s).
causes_true(q_17, o_sync_q_18s, q_17s).
causes_true(q_18, o_sync_q_18s, q_18s).
...
causes_false(q_7s, o_sync_q_7s, q_7s).
causes_false(f_ok, o_sync_q_7s, and(q_7s, 'started-o2')).
causes_false(q_7t, o_sync_q_7s, true).
causes_false(q_8s, o_sync_q_8s, q_8s).
causes_false(f_ok, o_sync_q_8s, and(q_8s, 'started-o1')).
...
causes_false(f_ok, o_sync_q_12s, and(q_12s, not('started-o3'))).
causes_false(q_12t, o_sync_q_12s, true).
causes_false(q_13s, o_sync_q_13s, q_13s).
causes_false(f_ok, o_sync_q_13s, and(q_13s, not('started-o2'))).
causes_false(q_13t, o_sync_q_13s, true).
causes_false(q_14s, o_sync_q_14s, q_14s).
causes_false(f_ok, o_sync_q_14s, and(q_14s, not('shipped-o3'))).
causes_false(q_14t, o_sync_q_14s, true).
causes_false(q_15s, o_sync_q_15s, q_15s).
causes_false(f_ok, o_sync_q_15s, and(q_15s, not('shipped-o2'))).
causes_false(q_15t, o_sync_q_15s, true).
causes_false(q_16s, o_sync_q_16s, q_16s).
causes_false(f_ok, o_sync_q_16s, and(q_16s, not('shipped-o1'))).
causes_false(q_16t, o_sync_q_16s, true).
causes_false(q_17s, o_sync_q_17s, q_17s).
causes_false(q_17t, o_sync_q_17s, true).
causes_false(f_ok, o_sync_q_18s, q_18s).
causes_false(q_18t, o_sync_q_18s, true).
causes_false(f_sync, o_sync_q_18s, true).
causes_false(q_1s, o_sync_q_18s, true).
causes_false(q_2s, o_sync_q_18s, true).
causes_false(q_3s, o_sync_q_18s, true).
causes_false(q_4s, o_sync_q_18s, true).
causes_false(q_5s, o_sync_q_18s, true).
causes_false(q_6s, o_sync_q_18s, true).
causes_false(q_7s, o_sync_q_18s, true).
causes_false(q_8s, o_sync_q_18s, true).
causes_false(q_9s, o_sync_q_18s, true).
causes_false(q_10s, o_sync_q_18s, true).
causes_false(q_11s, o_sync_q_18s, true).
causes_false(q_12s, o_sync_q_18s, true).
causes_false(q_13s, o_sync_q_18s, true).
causes_false(q_14s, o_sync_q_18s, true).
causes_false(q_15s, o_sync_q_18s, true).
causes_false(q_16s, o_sync_q_18s, true).
causes_false(q_17s, o_sync_q_18s, true).
causes_false(q_18s, o_sync_q_18s, true).
