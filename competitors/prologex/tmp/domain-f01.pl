...
poss(o_goal, and(and(f_world, f_ok), and(not(q_1), and(not(q_2), not(q_3))))).
...
causes_true(q_3, o_sync_q_1s_2, q_1s).
...
causes_true(f_world, o_sync_q_4s, true).
causes_true(q_1, o_sync_q_4s, q_1s).
causes_true(q_2, o_sync_q_4s, q_2s).
causes_true(q_3, o_sync_q_4s, q_3s).
causes_true(q_4, o_sync_q_4s, q_4s).
...
causes_false(f_ok, o_sync_q_2s, and(q_2s, not(communicated_soil_data(waypoint1)))).
causes_false(q_2t, o_sync_q_2s, true).
causes_false(q_3s, o_sync_q_3s, q_3s).
causes_false(q_3t, o_sync_q_3s, true).
causes_false(f_ok, o_sync_q_4s, q_4s).
causes_false(q_4t, o_sync_q_4s, true).
causes_false(f_sync, o_sync_q_4s, true).
causes_false(q_1s, o_sync_q_4s, true).
causes_false(q_2s, o_sync_q_4s, true).
causes_false(q_3s, o_sync_q_4s, true).
causes_false(q_4s, o_sync_q_4s, true).
