...
causes_true(q_15s, o_sync_q_1s_2, q_1s).
causes_true(q_1, o_sync_q_1s_2, q_1s).
causes_true(q_17, o_sync_q_1s_2, q_1s).
...
causes_true(q_8s, o_sync_q_4s, q_4s).
causes_true(q_5s, o_sync_q_4s, q_4s).
causes_true(q_5t, o_sync_q_4s, true).
causes_true(q_7s, o_sync_q_5s, q_5s).
...
causes_true(q_17, o_sync_q_7s_2, q_7s).
...
causes_true(q_17, o_sync_q_8s_2, q_8s).
...
causes_false(f_ok, o_sync_q_14s, and(q_14s, not(on(b1, b2)))).
causes_false(q_14t, o_sync_q_14s, true).
causes_false(q_15s, o_sync_q_15s, q_15s).
causes_false(f_ok, o_sync_q_15s, and(q_15s, not(ontable(b6)))).
causes_false(q_15t, o_sync_q_15s, true).
causes_false(q_16s, o_sync_q_16s, q_16s).
causes_false(f_ok, o_sync_q_16s, and(q_16s, not(holding(b6)))).
