...
causes_true(q_10, o_sync_q_1s_2, q_1s).
...
causes_true(q_9s, o_sync_q_6s_1, q_6s).
causes_true(q_7t, o_sync_q_6s_1, true).
causes_true(q_10, o_sync_q_6s_2, q_6s).
...
causes_false(f_ok, o_sync_q_7s, and(q_7s, not(on(b3, b4)))).
causes_false(q_7t, o_sync_q_7s, true).
causes_false(q_8s, o_sync_q_8s, q_8s).
causes_false(f_ok, o_sync_q_8s, and(q_8s, not(on(b2, b3)))).
causes_false(q_8t, o_sync_q_8s, true).
causes_false(q_9s, o_sync_q_9s, q_9s).
causes_false(f_ok, o_sync_q_9s, and(q_9s, not(on(b1, b2)))).
