...
BASE_DIR="/app/benchmarking/data/deterministic/FOND4LTLf/S24/blocksworld"
...
for i in {3..25}; do
    ...
    /app/bin/main_single_others "$DOMAIN_FILE" "$PROBLEM_FILE" 1 --method "$@" --search lama-first --goal "$BASE_DIR/blocksworld_teg2.json"
