(define (problem bw_10)
 ...
 (:goal 
            ...
            (next (eventually (and (on b8 b7)
            (next (eventually (and (on b9 b8)
            (next (eventually (and (on b10 b9)

            (next (eventually (and (on b9 b10)
            (next (eventually (and (on b8 b9)
            (next (eventually (and (on b7 b8)
